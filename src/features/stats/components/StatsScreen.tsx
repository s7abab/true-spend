...
type StatsKind = 'all' | 'expense' | 'income' | 'transfer';
...
export function StatsScreen({
  ...
  const expQ = useStatsAggregates(period, offset, 'expense', statsKind === 'all' || statsKind === 'expense');
  const incQ = useStatsAggregates(period, offset, 'income', statsKind === 'all' || statsKind === 'income');
  ...
  const activeSorted =
    statsKind === 'income' ? sortedIncome : statsKind === 'expense' ? sortedExpense : [];
