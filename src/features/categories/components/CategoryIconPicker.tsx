...
import { CATEGORY_ICON_PICKER_KEYS } from '@/features/categories/utils/constants';
...
export function CategoryIconPicker({ value, onChange, activeTint }: CategoryIconPickerProps) {
  return (
    <div>
      <div style={{ fontSize: 11, fontWeight: 600, color: '#ACACB8', marginBottom: 8, letterSpacing: 0.2 }}>
        Icon
      </div>
      <div
        style={{
