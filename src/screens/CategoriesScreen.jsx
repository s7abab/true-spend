              ...
              {editingId === c.id ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  ...
                  <input
                    ...
                    placeholder="Name"
                    style={{
                      width: '100%', height: 42, borderRadius: 10, border: 'none', background: '#F4F5F7',
                      padding: '0 12px', fontSize: 15, outline: 'none', fontFamily: 'inherit',
                    }}
                  />
                  <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
                    <button
                      ...
                      onClick={cancelEdit}
                      style={{
                        padding: '8px 14px', borderRadius: 10, border: 'none', background: '#F4F5F7',
                    ...
                    <button
                      ...
                      onClick={saveEdit}
                      style={{
                        padding: '8px 14px', borderRadius: 10, border: 'none', background: draft.trim() ? hero : '#E8E8EE',
                        color: draft.trim() ? '#fff' : '#ACACB8', fontWeight: 600, fontSize: 13, cursor: draft.trim() ? 'pointer' : 'default',
                        fontFamily: 'inherit',
                      }}
                    >
                      Save
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <button
                    ...
                    onClick={() => startEdit(c)}
                    style={{
                      border: 'none', background: 'transparent', color: hero, fontWeight: 600, fontSize: 13,
                      padding: '8px 4px', cursor: 'pointer', fontFamily: 'inherit', flexShrink: 0,
                    }}
                  >
                    Edit
                  </button>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 8, marginTop: 10 }}>
          <input
            ...
            placeholder="Name"
            style={{
              flex: 1, height: 46, borderRadius: 12, border: 'none', background: '#fff',
              padding: '0 14px', fontSize: 15, outline: 'none', fontFamily: 'inherit',
          ...
          <button
            ...
            onClick={addNew}
            style={{
              height: 46, padding: '0 20px', borderRadius: 12, border: 'none', fontWeight: 700, fontSize: 14,
              background: newName.trim() ? hero : '#E8E8EE', color: newName.trim() ? '#fff' : '#ACACB8',
              cursor: newName.trim() ? 'pointer' : 'default', fontFamily: 'inherit', flexShrink: 0,
            }}
          >
            Create
          </button>
